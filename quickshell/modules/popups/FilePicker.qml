            ...
            GridView {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        anchors.margins: 6
                        radius: 12
                        color: isSelected ? Qt.rgba(Colors.primary.r, Colors.primary.g, Colors.primary.b, 0.22) : itemHover.hovered ? Qt.rgba(Colors.primary.r, Colors.primary.g, Colors.primary.b, 0.1) : "transparent"
